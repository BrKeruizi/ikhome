...
import org.framework.ikhome.service.CourseCMService;
...
public class CourseCommand {
    ...
    public void getCourseCommand(Integer cid, Integer startpos, HttpServletResponse response) throws IOException {
        ...
        List<org.framework.ikhome.entity.CourseCommand> courseCommands = courseCMService.getCourseCommand(cid, startpos);
        ...
        if(count == 0){
            ...
            for (org.framework.ikhome.entity.CourseCommand courseCommand : courseCommands) {
    ...
    public void getCourseCommandGod(Integer cid, HttpServletResponse response) throws IOException {
        ...
        List<org.framework.ikhome.entity.CourseCommand> courseCommands = courseCMService.getCourseCommandGod(cid);
        int count = courseCommands.size();
        if(count == 0){
            res = "{\"count\": \""+courseCommands.size() + "\"}";
        }
    ...
    public void selMyCommand(Integer cid, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(username == null){
            ...
            List<org.framework.ikhome.entity.CourseCommand> courseCommands = courseCMService.getMyCommand(username, cid);
            int count = courseCommands.size();
            if(count == 0){
                res = "{\"count\": \""+courseCommands.size() + "\"}";
            }
