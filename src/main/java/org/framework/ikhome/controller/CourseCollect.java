...
import org.framework.ikhome.service.CourseCService;
...
public class CourseCollect {
    ...
    public void getMyCollect(HttpServletRequest request, HttpServletResponse response, Integer startpos) throws IOException {
        ...
        if(username == null){
            ...
            List<org.framework.ikhome.entity.CourseCollect> courseCollects = courseCService.getMyCollect(username, startpos);
            if(courseCollects.size() == 0){
                ...
                for (org.framework.ikhome.entity.CourseCollect courseCollect: courseCollects) {
    ...
    public void checkUserCollect(Integer cid, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        org.framework.ikhome.entity.CourseCollect courseCollect = courseCService.getCollect(cid, username);
