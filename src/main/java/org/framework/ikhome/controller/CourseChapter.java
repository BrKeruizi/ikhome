...
public class CourseChapter {
    ...
    public void getCourseChapter(Integer cid, HttpServletResponse response) throws IOException {
        ...
        List<org.framework.ikhome.entity.CourseChapter> courseChapters = courseChService.getCourseChapter(cid);
        if(courseChapters.size() == 0){
            ...
            res = "{";
            int i = 1;
            for (org.framework.ikhome.entity.CourseChapter courseChapter: courseChapters) {
                res += "\""+i+"\": ";
