...
import org.framework.ikhome.service.CourseLService;
...
public class CourseLog {
    ...
    public void getLog(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(username == null){
            ...
            //获取课程记录
            List<org.framework.ikhome.entity.CourseLog> courseLogs  = courseLService.getUserlog(username);
            if(courseLogs.size() == 0){
                ...
                for (org.framework.ikhome.entity.CourseLog courseLog : courseLogs) {
                    res += "\""+i+"\": ";
